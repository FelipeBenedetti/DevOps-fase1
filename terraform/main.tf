...
# Associação da tabela de rotas com subnets públicas
...
# Associação da tabela de rotas com subnets privadas
...
# Anexar política gerenciada para ECS Task Execution
